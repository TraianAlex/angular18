...
// src/app/movies/utils/movies-mock.interceptor.ts
// import { HttpInterceptorFn, HttpResponse } from '@angular/common/http';
// import { of } from 'rxjs';
// import { MOCKS } from './data';
// export const moviesMockInterceptor: HttpInterceptorFn = (req, next) => {
//   const path = new URL(req.url, window.location.origin).pathname;
//   for (const mock of MOCKS) {
//     const match = path.match(mock.path);
//     if (match) {
//       const param = match[1]; // captures :id
//       return of(new HttpResponse({ status: 200, body: mock.mockData(param) }));
//     }
//   }
//   return next(req);
// };